...
<body class="antialiased selection:bg-white selection:text-black flex min-h-screen">
    ...
    <main class="flex-1 overflow-y-auto bg-[#0a0a0a] relative">
        ...
        <div class="p-6 md:p-12 lg:p-16 max-w-6xl mx-auto">
            ...
            <div class="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
                ...
                <a href="/admin/about/create" class="px-6 py-3 rounded-full text-sm font-bold bg-white text-black hover:bg-gray-200 transition-all flex items-center gap-2 shadow-[0_0_15px_rgba(255,255,255,0.15)] w-fit">
                    ...
                    <table class="w-full text-left border-collapse">
                        <thead>
                            <tr class="bg-white/[0.02] border-b border-white/10 text-xs uppercase tracking-widest text-zinc-500">
                                ...
                                <th class="p-6 font-semibold">Content Snippet</th>
                        ...
                        <tbody id="aboutTableBody" class="divide-y divide-white/5 text-sm">
                            ...
                            <tr id="row-1" class="hover:bg-white/[0.02] transition-colors group">
                                <td class="p-6">
                                    <div class="w-16 h-20 rounded-xl overflow-hidden border border-white/10">
                                        <img src="https://images.unsplash.com/photo-1490806843957-31f4c9a91c65?q=80&w=200" class="w-full h-full object-cover" alt="Japan Street">
                                    </div>
                                </td>
                                <td class="p-6 font-bold text-white text-base">My background in Architecture.</td>
                                <td class="p-6 text-zinc-400 max-w-xs truncate">In June of 2022, I graduated from architecture school at the University of Toronto...</td>
                                <td class="p-6">
                                    <div class="flex items-center justify-end gap-3 opacity-100 md:opacity-0 group-hover:opacity-100 transition-opacity">
                                        <button type="button" onclick="openViewModal('My background in Architecture.', 'In June of 2022, I graduated from architecture school at the University of Toronto. There, I became obsessed with architectural visualization.\n\nI was deeply fascinated in the concepts of modularity and adaptability.', 'https://images.unsplash.com/photo-1490806843957-31f4c9a91c65?q=80&w=600', '/admin/about/1/edit')" class="w-8 h-8 rounded-full bg-white/5 flex items-center justify-center text-zinc-400 hover:text-white hover:bg-white/10 transition-colors" title="View Details">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path></svg>
                                        </button>
                                        <a href="/admin/about/1/edit" class="w-8 h-8 rounded-full bg-blue-500/10 flex items-center justify-center text-blue-400 hover:text-white hover:bg-blue-500/30 transition-colors" title="Edit">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"></path></svg>
                                        </a>
                                        <button type="button" onclick="openDeleteModal('My background in...', 'row-1')" class="w-8 h-8 rounded-full bg-red-500/10 flex items-center justify-center text-red-400 hover:text-white hover:bg-red-500/30 transition-colors" title="Delete">
    ...
    <div id="viewModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm opacity-0 pointer-events-none transition-opacity duration-300 p-4">
        <div id="viewModalContent" class="bg-[#141414] border border-white/10 rounded-3xl p-0 w-full max-w-4xl transform scale-95 transition-transform duration-300 shadow-2xl overflow-hidden flex flex-col md:flex-row max-h-[90vh]">
            <div class="w-full md:w-5/12 h-64 md:h-auto relative">
                <img id="viewImage" src="" alt="Story Image" class="w-full h-full object-cover">
            ...
            <div class="p-8 md:p-12 w-full md:w-7/12 flex flex-col justify-center relative overflow-y-auto hide-scrollbar">
                ...
                <a id="viewEditBtn" href="#" class="px-6 py-3 rounded-full text-sm font-bold bg-white text-black hover:bg-gray-200 transition-all text-center shadow-[0_0_15px_rgba(255,255,255,0.15)] w-fit mt-auto">Edit Block</a>
            </div>
        </div>
    </div>
    ...
    <script>
        ...
        function openDeleteModal(title, rowId) {
            deleteNameSpan.textContent = title;
        ...
        document.getElementById('deleteBlockForm').addEventListener('submit', function(e) {
            ...
            closeDeleteModal();
            swalDark.fire({
                icon: 'success', title: 'Deleted!', text: 'Story block removed.',
        ...
        function openViewModal(title, content, imgSrc, editUrl) {
