    ...
    <main class="flex-1 overflow-y-auto bg-[#0a0a0a] relative">
        ...
        <div class="p-6 md:p-12 lg:p-16 max-w-6xl mx-auto">
            ...
            <div class="mb-10 flex flex-col md:flex-row md:items-end justify-between gap-6">
                ...
                <a href="/admin/clients/create" class="px-6 py-3 rounded-full text-sm font-bold bg-white text-black hover:bg-gray-200 transition-all flex items-center gap-2 shadow-[0_0_15px_rgba(255,255,255,0.15)] w-fit">
                    ...
                    <table class="w-full text-left border-collapse">
                        ...
                        <tbody id="clientTableBody" class="divide-y divide-white/5 text-sm">
                            ...
                            <tr id="row-1" class="hover:bg-white/[0.02] transition-colors group">
                                <td class="p-6">
                                    <div class="w-12 h-12 rounded-xl overflow-hidden bg-white/5 border border-white/10 flex items-center justify-center p-2">
                                        <img src="https://upload.wikimedia.org/wikipedia/commons/1/19/Spotify_logo_without_text.svg" class="w-full h-full object-contain" alt="Spotify">
                                    </div>
                                </td>
                                <td class="p-6">
                                ...
                                <td class="p-6">
                                    <div class="flex items-center justify-end gap-3 opacity-100 md:opacity-0 group-hover:opacity-100 transition-opacity">
                                        ...
                                        <!-- Edit -->
                                        <a href="/admin/clients/1/edit" class="w-8 h-8 rounded-full bg-blue-500/10 flex items-center justify-center text-blue-400 hover:text-white hover:bg-blue-500/30 transition-colors" title="Edit">
                            ...
                            <tr id="row-2" class="hover:bg-white/[0.02] transition-colors group">
                                ...
                                <td class="p-6">
                                    <div class="flex items-center justify-end gap-3 opacity-100 md:opacity-0 group-hover:opacity-100 transition-opacity">
                                        ...
                                        <a href="/admin/clients/2/edit" class="w-8 h-8 rounded-full bg-blue-500/10 flex items-center justify-center text-blue-400 hover:text-white hover:bg-blue-500/30 transition-colors" title="Edit">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"></path></svg>
                                        </a>
                            ...
                            <tr id="row-3" class="hover:bg-white/[0.02] transition-colors group">
                                <td class="p-6">
                                    <div class="w-12 h-12 rounded-xl overflow-hidden bg-white/5 border border-white/10 flex items-center justify-center p-2">
                                        <img src="https://upload.wikimedia.org/wikipedia/commons/a/ab/Apple-logo.png" class="w-full h-full object-contain filter invert" alt="Apple">
                                    </div>
                                </td>
                                <td class="p-6">
                                ...
                                <td class="p-6">
                                    <div class="flex items-center justify-end gap-3 opacity-100 md:opacity-0 group-hover:opacity-100 transition-opacity">
                                        ...
                                        <a href="/admin/clients/3/edit" class="w-8 h-8 rounded-full bg-blue-500/10 flex items-center justify-center text-blue-400 hover:text-white hover:bg-blue-500/30 transition-colors" title="Edit">
                                            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15.232 5.232l3.536 3.536m-2.036-5.036a2.5 2.5 0 113.536 3.536L6.5 21.036H3v-3.572L16.732 3.732z"></path></svg>
                                        </a>
    ...
    <div id="viewModal" class="fixed inset-0 z-50 flex items-center justify-center bg-black/60 backdrop-blur-sm opacity-0 pointer-events-none transition-opacity duration-300 p-4">
        <div id="viewModalContent" class="bg-[#141414] border border-white/10 rounded-3xl p-8 w-full max-w-sm transform scale-95 transition-transform duration-300 shadow-2xl relative text-center">
            ...
            <div id="viewLogoContainer" class="w-32 h-32 mx-auto rounded-2xl bg-white/5 border border-white/10 flex items-center justify-center p-4 mb-6">
                <img id="viewImage" src="" alt="Client Logo" class="w-full h-full object-contain filter invert">
            </div>

            <!-- Menampilkan Nama -->
            <h3 id="viewTitle" class="text-2xl font-bold text-white mb-2"></h3>
            <p class="text-zinc-500 text-xs uppercase tracking-widest font-bold">Selected Client</p>
