...
<head>
    ...
    <title>Admin Dashboard - Edit Showcase</title>
...
<body class="antialiased selection:bg-white selection:text-black flex min-h-screen">
        ...
        <div class="p-6 md:p-12 lg:p-16 max-w-5xl mx-auto">
            ...
            <div class="mb-10">
                <div class="flex items-center gap-2 text-sm text-zinc-500 font-medium mb-3">
                    ...
                    <span>/</span>
                    <span class="text-white">Edit Project</span>
                </div>
                <h1 class="text-3xl md:text-4xl font-bold tracking-tight text-white">Edit Project</h1>
                <p class="text-zinc-400 mt-2">Update the details of your portfolio showcase.</p>
            </div>

            <form id="editProjectForm" action="#" method="POST" enctype="multipart/form-data" class="bg-[#141414] border border-white/10 rounded-3xl p-8 md:p-10 shadow-2xl relative overflow-hidden">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    <div class="space-y-6">
                        <div>
                            ...
                            <input type="text" name="title" value="Nexus Platform" required class="w-full bg-[#0a0a0a] border border-white/10 rounded-xl px-4 py-3 text-white focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-all">
                        </div>

                        <div>
                            <label class="block text-sm font-semibold text-zinc-300 mb-2">Company & Year</label>
                            <input type="text" name="company" value="Google, '23" required class="w-full bg-[#0a0a0a] border border-white/10 rounded-xl px-4 py-3 text-white focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-all font-jetbrains text-sm">
                        </div>
                        ...
                        <div>
                            ...
                            <div class="flex gap-3">
                                ...
                                <button type="button" onclick="openCategoryModal()" class="px-4 bg-white/5 hover:bg-white/10 border border-white/10 rounded-xl text-sm font-medium transition-colors text-white flex items-center gap-2">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <textarea name="desc" rows="4" required class="w-full bg-[#0a0a0a] border border-white/10 rounded-xl px-4 py-3 text-white focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-all resize-none">Membangun ekosistem yang berkelanjutan.</textarea>
                        </div>
                        ...
                        <div>
                            ...
                            <div class="mb-3 w-full h-24 rounded-lg overflow-hidden border border-white/10">
                                <img src="https://images.unsplash.com/photo-1618005182384-a83a8bd57fbe?q=80&w=400" alt="Current Image" class="w-full h-full object-cover opacity-60">
                            </div>
    ...
    <script>
        ...
        // --- Simulasi Simpan Edit Project dengan SweetAlert ---
