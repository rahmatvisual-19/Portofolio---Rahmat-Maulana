...
<head>
    ...
    <title>Admin Dashboard - Edit Tool</title>
    ...
    <main class="flex-1 overflow-y-auto bg-[#0a0a0a] relative">
        ...
        <div class="p-6 md:p-12 lg:p-16 max-w-2xl mx-auto">
            ...
            <div class="mb-10">
                ...
                <h1 class="text-3xl md:text-4xl font-bold tracking-tight text-white">Edit Tool Details</h1>
                <p class="text-zinc-400 mt-2">Update the name of the technology in your stack.</p>
            </div>

            <form id="editToolForm" action="#" method="POST" class="bg-[#141414] border border-white/10 rounded-3xl p-8 md:p-10 shadow-2xl relative overflow-hidden">
                @csrf
                @method('PUT')
                ...
                <div class="space-y-6">
                    <div>
                        ...
                        <input type="text" name="name" value="React" required class="w-full bg-[#0a0a0a] border border-white/10 rounded-xl px-4 py-3 text-white focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-all font-jetbrains">
                    </div>
                </div>
