...
<head>
    ...
    <title>Admin Dashboard - Add Experience</title>
...
<body class="antialiased selection:bg-white selection:text-black flex min-h-screen">
    ...
    <main class="flex-1 overflow-y-auto bg-[#0a0a0a] relative">
        ...
        <div class="p-6 md:p-12 lg:p-16 max-w-3xl mx-auto">
            ...
            <div class="mb-10">
                ...
                <h1 class="text-3xl md:text-4xl font-bold tracking-tight text-white">Add Experience</h1>
                <p class="text-zinc-400 mt-2">Add a new entry to your work history.</p>
            </div>

            <form id="createForm" action="#" method="POST" class="bg-[#141414] border border-white/10 rounded-3xl p-8 md:p-10 shadow-2xl relative overflow-hidden">
                @csrf
    ...
    <script>
        ...
        document.getElementById('createForm').addEventListener('submit', function(e) {
            e.preventDefault();
            swalDark.fire({ icon: 'success', title: 'Experience Added!', text: 'New experience entry has been saved.', showConfirmButton: false, timer: 2000 })
