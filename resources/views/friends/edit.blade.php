...
<body class="antialiased selection:bg-white selection:text-black flex h-screen overflow-hidden">
        ...
        <div class="p-6 md:p-12 lg:p-16 max-w-4xl mx-auto">
            ...
            <div class="mb-10">
                <div class="flex items-center gap-2 text-sm text-zinc-500 font-medium mb-3">
                    ...
                    <span>/</span>
                    <span class="text-white">Edit Record</span>
                </div>
                <h1 class="text-3xl md:text-4xl font-bold tracking-tight text-white">Edit Friend Details</h1>
                <p class="text-zinc-400 mt-2">Update the contact or role information.</p>
            </div>

            <form id="editFriendForm" action="#" method="POST" class="bg-[#141414] border border-white/10 rounded-3xl p-8 md:p-10 shadow-2xl relative overflow-hidden">
                @csrf
                @method('PUT')
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-8">
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <input type="text" name="name" value="Xavier Woo" required class="w-full bg-[#0a0a0a] border border-white/10 rounded-xl px-4 py-3 text-white focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-all">
                        </div>

                        <div>
                            <label class="block text-sm font-semibold text-zinc-300 mb-2">Position / Role</label>
                            <input type="text" name="role" value="Founding Designer" required class="w-full bg-[#0a0a0a] border border-white/10 rounded-xl px-4 py-3 text-white focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-all">
                        </div>
                    </div>
                    ...
                    <div class="space-y-6">
                        <div>
                            ...
                            <input type="text" name="company" value="Blockus" required class="w-full bg-[#0a0a0a] border border-white/10 rounded-xl px-4 py-3 text-white focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-all">
                        </div>

                        <div>
                            <label class="block text-sm font-semibold text-zinc-300 mb-2">Social / Work Link</label>
                            <input type="url" name="link" value="https://xavierw.ca" required class="w-full bg-[#0a0a0a] border border-white/10 rounded-xl px-4 py-3 text-white focus:border-blue-500 focus:ring-1 focus:ring-blue-500 outline-none transition-all font-jetbrains text-sm text-blue-400">
    ...
    <script>
        ...
        document.getElementById('editFriendForm').addEventListener('submit', function(e) {
            e.preventDefault(); 
            swalDark.fire({
                icon: 'success', title: 'Changes Saved!', text: 'Friend details updated successfully.',
